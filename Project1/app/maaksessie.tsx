...
export default function MaakSessie() {
  ...
  const handleOpslaan = async () => {
    ...
    const sessieId = await addSession(nieuweSessieData);
    await addDoc(collection(db, "chats"), {
      players: [auth.currentUser?.uid],
      sessionId: sessieId,
      lastMessage: "",
      mapName: nieuweSessieData.mapName,
      sessionType: nieuweSessieData.sessionType,
      date: nieuweSessieData.date,
  ...
  const verwerkMaxLevelInput = (input: string) => {
    if (
      input === "" ||
      (parseFloat(input) >= 0.5 && parseFloat(input) <= 7.0)
    ) {
      setOngeldigeMaxLevel(false);
      setMaxLevel(input);
    } else setOngeldigeMaxLevel(true);
  };
  ...
  const verwerkMinLevelInput = (input: string) => {
    if (
      ...
      setMinLevel(input);
    } else setOngeldigeMinLevel(true);
  };
    ...
    >
      ...
      <View style={styles.row}>
        {beschikbareMaps.map((mapOptie) => (
          <TouchableOpacity
            ...
            style={[
              styles.choiceButton,
              mapName === mapOptie && styles.choiceButtonSelected,
            ]}
          ...
          >
            <Text
              style={[
                styles.choiceText,
                mapName === mapOptie && styles.choiceTextSelected,
              ]}
            >
              {mapOptie}
            </Text>
      ...
      <View style={styles.row}>
        ...
        >
          <Text
            style={[
              styles.choiceText,
              isCompetitive === true && styles.choiceTextSelected,
            ]}
          >
            Competitief
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.choiceButton,
            isCompetitive === false && styles.choiceButtonSelected,
          ]}
        ...
        >
          <Text
            style={[
              styles.choiceText,
              isCompetitive === false && styles.choiceTextSelected,
            ]}
          >
            Vriendschappelijk
          </Text>
      ...
      <View style={styles.row}>
        <TouchableOpacity
          style={[
            styles.choiceButton,
            sessionType === "match" && styles.choiceButtonSelected,
          ]}
        ...
        >
          <Text
            style={[
              styles.choiceText,
              sessionType === "match" && styles.choiceTextSelected,
            ]}
          >
            Match (4p)
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.choiceButton,
            sessionType === "practice" && styles.choiceButtonSelected,
          ]}
          onPress={() => {
        ...
        >
          <Text
            style={[
              styles.choiceText,
              sessionType === "practice" && styles.choiceTextSelected,
            ]}
          >
            Practice (Privé)
          </Text>

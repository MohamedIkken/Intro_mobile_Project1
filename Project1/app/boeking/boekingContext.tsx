...
export function BookingProvider({ children }: { children: ReactNode }) {
  ...
  ); // Afhankelijkheden van de useCallback: deze functie zal opnieuw worden gemaakt als het geselecteerde slot, de servernaam in de filters of de maakBoeking functie veranderen
